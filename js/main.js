...
function addList(list,arr){
    ...
    list.forEach((value, index) => {
        ...
        <div class="flex items-center">
                <button onclick={clickCheck(${value.id})} class="w-[40px] h-[40px] mr-[5px]  rounded-[45%] border-[2px] border-violet-300 ${value.isComplated ? "white" : "bg-violet-500" } flex justify-center items-center"><svg width="30" height="30" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <defs>
